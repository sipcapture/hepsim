...
const hepModule = {
     ...
     * @param {number} payloadType - 1 SIP, 'JSON' for RTCP and RTP reports
     ...
     */
    generateRCInfo: function (captureId, capturePass, payloadType, correlation_id, proto_type, sourceIP, destinationIP, sourcePort, destinationPort) {
        return {
